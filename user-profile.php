	...
	if (strlen($_SESSION['detsuid']==0)) {
		...
		if(isset($_POST['submit'])){
			...
			if(isset($_SESSION['userType']) && $_SESSION['userType'] == 1){
				$query=mysqli_query($con, "update login_details set fullName ='$fullname', mobileNumber='$mobno' where id='$userid'");
				$msg="User profile has been updated.";
			}elseif(isset($_SESSION['userType']) && $_SESSION['userType'] == 2){
					$query=mysqli_query($con, "update student_details set fullName ='$fullname', mobileNumber='$mobno' where id='$userid'");
					$msg="User profile has been updated.";
			}
			else{
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
									<?php
										$userid=$_SESSION['detsuid'];
										if(isset($_SESSION['userType']) && $_SESSION['userType'] == 1){
											$ret=mysqli_query($con,"select * from login_details where id='$userid'");
										}else{
											$ret=mysqli_query($con,"select * from student_details where id='$userid'");
										}
										$cnt=1;
									...
									<form role="form" method="post" action="">
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" value="<?php  echo $row['password'];?>" required="true" name="password" maxlength="10" disabled>
										</div>
										<div class="form-group">
