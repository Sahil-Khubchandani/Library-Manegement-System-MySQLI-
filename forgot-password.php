...
if(isset($_POST['submit'])){
    ...
    $email=$_POST['email'];
    $query=mysqli_query($con,"select * from student_details where  email='$email' and mobileNumber='$mobileNumber' ");
				...
				<div class="panel-body">
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" placeholder="Mobile Number" name="mobileNumber" type="mobileNumber" value="" required="true">
							</div>
							<div class="checkbox">
